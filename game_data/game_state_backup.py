# game_data/game_state_backup.py
...
# Утилитные функции вместо глобального состояния
def create_default_game_state():
    """Создает начальное состояние игры (для совместимости со старым кодом)"""
    return {
...
def init_save_system(game_state):
